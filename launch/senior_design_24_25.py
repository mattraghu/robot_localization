...
LAUNCH_CONFIG = {
    ...
    "parameter_file_path": "senior_design_24_25.yaml",
    ...
    "nodes": [
        ...
        # {
        #     "name": "static_tf_map_to_odom_boot",
        #     "package": "tf2_ros",
        #     "executable": "static_transform_publisher",
        #     "output": "screen",
    ...
    "bag_files": [
        {
            "file_path": "/media/kearfott/PBKFD-104/rosbag2_2025_04_29-17_08_56/rosbag2_2025_04_29-17_08_56_0.db3",
            "start_offset": 190.0,
            "remaps": {
                "imu/data" : "imu/raw",
            }
